...
export const inspectionItemTemplateTranslationTemplatePTData = async (
  ...
  const data: {
    ...
    //1
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Verificar visualmente ao redor do equipamento de trabalho',
      item_description:
        'Inspecionar equipamentos de trabalho, cilindros, articulação e mangueiras quanto a danos, desgaste e folga',
    },
    {
      inspection_item_id: '01HK4QBQJD17KT5ZEYA0N3HVYS',
      iso_locale_code: 'pt',
      item_name: 'Verificar visualmente ao redor da máquina',
      item_description:
        'Verificar a existência de danos, deformações, trincas, folgas e perda de peças',
    },
    {
      inspection_item_id: '01HK4QBQJD0406HG49VHQ8NFKV',
      iso_locale_code: 'pt',
      item_name:
        'Vazamentos de óleo e líquido de arrefecimento do motor e do sistema hidráulico',
      item_description:
        'Verificar vazamento de líquido de arrefecimento e de óleo do motor/sistema de refrigeração e dos componentes hidráulicos',
    },
    {
      inspection_item_id: '01HK4QBQJDNNTZWJ0XB2542Y36',
      iso_locale_code: 'pt',
      item_name:
        'Nível do óleo do motor/ sistema hidráulico e líquido de arrefecimento',
      item_description:
        'Verificar o nível de óleo do motor, dos componentes hidráulicos e do sistema de arrefecimento',
    },
    {
      ...
      item_name: 'Bateria',
      item_description:
        'Verifique o nível do fluido da bateria, deformação, sujeira e fiação solta',
    },
    {
      inspection_item_id: '01HK4QBQJEQV14AKHR3K9VPQKP',
      iso_locale_code: 'pt',
      item_name: 'Funcionamento dos dispositivos de segurança',
      item_description:
        'Verificação do funcionamento dos faróis, indicadores de direção, alarmes, etc. , e seu funcionamento normal',
    },
    {
      inspection_item_id: '01HK4QBQJEAAV2Y3FZCK2MXDBX',
      iso_locale_code: 'pt',
      item_name: 'Danos no equipamento de segurança',
      item_description:
        'Verifique se há vidros rachados ou quebrados, espelhos faltando ou quebrados e danos em degraus e corrimãos (se for aplicável)',
    },
    {
      inspection_item_id: '01HK4QBQJEHJA5D4NM03SRWR0B',
      iso_locale_code: 'pt',
      item_name: 'Material rodante, freios, pneus',
      item_description:
        'Verificar os pneus furados ou danificados e o funcionamento dos freios',
    },
    {
      inspection_item_id: '01HK4QBQJEHAGVSPE9M8MV887J',
      iso_locale_code: 'pt',
      item_name: 'Componentes eléctricos',
      item_description:
        'Verifique o status dos alarmes e luzes de advertência no painel/display do monitor',
    },
    {
      inspection_item_id: '01HK4QFQ1AEVDQYFPYE8HDTX40',
      iso_locale_code: 'pt',
      item_name: 'Horímetro (SMR)',
      item_description: '',
    },
    {
      inspection_item_id: '01HK4R8HHE4E5R0SKKTJ03RGPR',
      iso_locale_code: 'pt',
      item_name: 'Odômetro (km)',
      item_description: '',
    },
    //2
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Verifique a visualmente ao redor do equipamento de trabalho',
      item_description:
        'Inspecionar equipamentos de trabalho, cilindros, ligações e mangueiras quanto a danos, desgaste e folga',
    },
    {
      inspection_item_id: '01HK4R9TN723N5286RHTR1GZ74',
      iso_locale_code: 'pt',
      item_name: 'Verifique visualmente ao redor da máquina',
      item_description:
        'Verificar dano, deformação, rachadura, afrouxamento ou queda de partes da máquina',
    },
    {
      inspection_item_id: '01HK4R9TN75GE24YR06M28H8WE',
      iso_locale_code: 'pt',
      item_name: 'Tanque de combustível, separador de água',
      item_description:
        'Verificar o tanque de combustível, separador de água, drenar a água e os sedimentos',
    },
    {
      inspection_item_id: '01HK4R9TN78PB15KYDM3ADKRBD',
      iso_locale_code: 'pt',
      item_name: 'Nível do líquido de arrefecimento',
      item_description:
        'Verificar o nível do líquido de arrefecimento, adicionar líquido de arrefecimento',
    },
    {
      inspection_item_id: '01HK4R9TN7FXK32NVYVQ3MPY90',
      iso_locale_code: 'pt',
      item_name: 'Nível do óleo do motor',
      item_description:
        'Verificar o nível de óleo no cárter do motor, adicionar óleo (se necessário)',
    },
    {
      inspection_item_id: '01HK4R9TN7EKDQ76Q4XYN87EWH',
      iso_locale_code: 'pt',
      item_name: 'Nível de combustível',
      item_description:
        'Verificar o nível de combustível, abastecer combustível (se necessário)',
    },
    {
      inspection_item_id: '01HK4R9TN7VSK08626X3ERGZAG',
      iso_locale_code: 'pt',
      item_name: 'Nível do óleo hidráulico',
      item_description:
        'Verifique o nível de óleo no tanque hidráulico, adicionar óleo (se necessário)',
    },
    {
      inspection_item_id: '01HK4R9TN7RRXCFXHF0YPAMXD1',
      iso_locale_code: 'pt',
      item_name: 'Indicador de obstrução do filtro de ar',
      item_description: 'Verificar o indicador de obstrução do filtro de ar',
    },
    {
      inspection_item_id: '01HK4R9TN8CB8BP9A3K8A3B82Y',
      iso_locale_code: 'pt',
      item_name: 'Fiação elétrica',
      item_description: 'Verificar a fiação elétrica',
    },
    {
      inspection_item_id: '01HK4R9TN8G1NSF03X4VG3ETMP',
      iso_locale_code: 'pt',
      item_name: 'Iluminação',
      item_description: 'Verificar se as luzes acendem',
    },
    {
      inspection_item_id: '01HK4R9TN8BCJYTWZ03ZG9C2WN',
      iso_locale_code: 'pt',
      item_name: 'Som da buzina',
      item_description: 'Verificar o som da buzina',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Nível do óleo da transmissão/trem de força',
      item_description:
        'Verificar o nível de óleo da transmissão/trem de força Adicionar óleo (se necessário)',
    },
    {
      ...
      item_name: 'Pneus',
      item_description:
        'Inspecionar danos nos pneus, pressão do ar, parafusos e porcas das rodas',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Painel monitor',
      item_description: 'Verificar o painel monitor',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Nível do óleo do trem de força',
      item_description:
        'Verificar o nível de óleo do trem de força Adicionar óleo (se necessário)',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Alarme de marcha ré',
      item_description: 'Verificar o funcionamento do alarme de marcha ré',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Volante de direção',
      item_description: 'Verificar e ajustar o volante de direção',
    },
    {
      inspection_item_id: '01HK4SS2SR18C29ZQEBDZBSWRK',
      iso_locale_code: 'pt',
      item_name: 'Pino de travamento da articulação',
      item_description: 'Verificar o pino travamento da articulação',
    },
    {
      inspection_item_id: '01HK4SS2SR913KTB7CFT40BQEH',
      iso_locale_code: 'pt',
      item_name: 'Batente de inclinação',
      item_description: 'Verificar o batente de inclinação',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Nível do óleo da transmissão',
      item_description:
        'Verificar o nível de óleo da transmissão Adicionar óleo (se necessário)',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Direção secundária',
      item_description: 'Verificar a direção secundária',
    },
    {
      inspection_item_id: '01HK4T101RKDPTGJ352NN16YPM',
      iso_locale_code: 'pt',
      item_name: 'Funcionamento dos freios',
      item_description: 'Verificar o funcionamento dos freios',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Sistema hidráulico, bateria',
      item_description: 'Verifique vazamento de óleo/bateria',
    },
    {
      inspection_item_id: '01HK4TQMTYRJACJJ25BS70BBPN',
      iso_locale_code: 'pt',
      item_name: 'Nível do eletrólito da bateria',
      item_description: 'Verifique o nível de eletrólito da bateria',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Nível do óleo dos freios',
      item_description: 'Verificar o nível do óleo dos freios',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Freio de estacionamento',
      item_description: 'Verificar o freio de estacionamento',
    },
    {
      inspection_item_id: '01HK4TQMTZCKHHTG2Y490D1KG1',
      iso_locale_code: 'pt',
      item_name: 'Pedal do freio',
      item_description: 'Verificar o pedal do freio',
    },
    {
      inspection_item_id: '01HK4TQMTZ2JE3DFVACE4DMGWV',
      iso_locale_code: 'pt',
      item_name: 'Funcionamento do freio',
      item_description: 'Verificar o funcionamento dos freios',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Danos nas lâmpadas e nas lentes',
      item_description:
        'Verificar a existência de contaminação e/ou danos na lâmpada, lente, etc',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Espelhos retrovisores',
      item_description:
        'Verifique os espelhos laterais e os espelhos retrovisores inferiores',
    },
    {
      inspection_item_id: '01HK4TQMV0BZ3JCMWNRNRRX1N5',
      iso_locale_code: 'pt',
      item_name: 'Cinto de segurança',
      item_description:
        'Verificar danos no cinto de segurança e testar o funcionamento',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Nível do óleo da transmissão',
      item_description: 'Verificar o nível de óleo da transmissão',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Nível do eletrólito da bateria',
      item_description: 'Verificar o nível de eletrólito da bateria',
    },
    {
    ...
    },
    {
      ...
      item_name: 'Cinto de segurança',
      item_description:
        'Verificar os cintos de segurança quanto a danos e funcionamento',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'pt',
      item_name: 'Britador de mandíbulas',
      item_description: 'Verificar o britador de mandíbulas',
    },
    {
      inspection_item_id: '01HK4WACP3BEK5EQCVXYZED95Q',
      iso_locale_code: 'pt',
      item_name: 'Correia transportadora primária',
      item_description: 'Verificar e limpar a correia transportadora primária',
    },
    {
      inspection_item_id: '01HK4WACP4TSFPJZJA2C6NH64Y',
      iso_locale_code: 'pt',
      item_name: 'Alimentador',
      item_description: 'Verificar o alimentador',
    },
    {
      inspection_item_id: '01HK4WACP4JTFZHAD5E59N1TPQ',
      iso_locale_code: 'pt',
      item_name: 'Separador magnético',
      item_description: 'Verificar o separador magnético',
    },
    {
