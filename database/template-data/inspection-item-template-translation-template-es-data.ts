...
export const inspectionItemTemplateTranslationTemplateESData = async (
  ...
  const data: {
    ...
    //1
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Revisión visual alrededor del equipo de trabajo',
      item_description:
        'Revise el equipo de trabajo, los cilindros, la conexión y las mangueras de daños, desgaste y juego',
    },
    {
      inspection_item_id: '01HK4QBQJD17KT5ZEYA0N3HVYS',
      iso_locale_code: 'es',
      item_name: 'Revisión visual alrededor de la máquina',
      item_description:
        'Verifique los daños, deformaciones, fisuras, aflojamientos y partes faltantes',
    },
    {
      inspection_item_id: '01HK4QBQJD0406HG49VHQ8NFKV',
      iso_locale_code: 'es',
      item_name: 'Fuga del sistema del motor/hidráulico',
      item_description:
        'Revise fugas de refrigerante y aceite desde motor/sistema de refrigerante, componentes hidráulicos',
    },
    {
      inspection_item_id: '01HK4QBQJDNNTZWJ0XB2542Y36',
      iso_locale_code: 'es',
      item_name: 'Nivel de aceite/refrigerante del motor/hidráulico',
      item_description:
        'Verifique el nivel de aceite del motor, los componentes hidráulicos y el sistema de refrigerante',
    },
    {
      ...
      item_name: 'Batería',
      item_description:
        'Revise el nivel de fluido de la batería, la deformación/suciedad/obstrucción y las arnés de cables',
    },
    {
      inspection_item_id: '01HK4QBQJEQV14AKHR3K9VPQKP',
      iso_locale_code: 'es',
      item_name: 'Funcionamiento de los dispositivos de seguridad',
      item_description:
        'Confirmar que los faros, las luces intermitentes, alarmas están funcionando correctamente',
    },
    {
      inspection_item_id: '01HK4QBQJEAAV2Y3FZCK2MXDBX',
      iso_locale_code: 'es',
      item_name: 'Daño en el equipo de seguridad',
      item_description:
        'Revisar vidrios, espejos, escaleras o pasamanos dañados/faltantes/rotos (si corresponde)',
    },
    {
      inspection_item_id: '01HK4QBQJEHJA5D4NM03SRWR0B',
      iso_locale_code: 'es',
      item_name: 'Tren de rodaje, Freno, Neumático',
      item_description:
        'Revisar neumáticos desinflados o dañados, funcionamiento de los frenos',
    },
    {
      inspection_item_id: '01HK4QBQJEHAGVSPE9M8MV887J',
      iso_locale_code: 'es',
      item_name: 'Componente eléctrico',
      item_description:
        'Revisar alarmas activas o notificaciones de lámparas de precaución en la pantalla electrónica',
    },
    {
      inspection_item_id: '01HK4QFQ1AEVDQYFPYE8HDTX40',
      iso_locale_code: 'es',
      item_name: 'Horómetro/SMR (h)',
      item_description: '',
    },
    {
      inspection_item_id: '01HK4R8HHE4E5R0SKKTJ03RGPR',
      iso_locale_code: 'es',
      item_name: 'Odómetro (km)',
      item_description: '',
    },
    //2
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Tanque de combustible,Separador de agua',
      item_description:
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Nivel de refrigerante',
      item_description:
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Nivel de aceite del motor',
      item_description:
    ...
    },
    {
      ...
      item_description: 'Revisar el nivel de combustible, agregar combustible',
    },
    {
      inspection_item_id: '01HK4R9TN7VSK08626X3ERGZAG',
      iso_locale_code: 'es',
      item_name: 'Nivel de aceite hidráulico',
      item_description:
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Indicador de polvo',
      item_description: 'Verificar el indicador de polvo',
    },
    {
      inspection_item_id: '01HK4R9TN8CB8BP9A3K8A3B82Y',
      iso_locale_code: 'es',
      item_name: 'Cableado eléctrico',
      item_description: 'Revisar el arnés de cables eléctricos',
    },
    {
      inspection_item_id: '01HK4R9TN8G1NSF03X4VG3ETMP',
      iso_locale_code: 'es',
      item_name: 'Encendido de luces',
      item_description: 'Verifique que las luces se encienden',
    },
    {
      inspection_item_id: '01HK4R9TN8BCJYTWZ03ZG9C2WN',
      iso_locale_code: 'es',
      item_name: 'Sonido de la bocina',
      item_description: 'Comprobar el sonido de la bocina',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Nivel de aceite de transmisión/tren de potencia',
      item_description:
        'Revisar el nivel de aceite en el cárter de la transmisión/tren de potencia, agregar aceite',
    },
    {
      inspection_item_id: '01HK4RP8TGCCH7WTKFKWRT15C9',
      iso_locale_code: 'es',
      item_name: 'Neumáticos',
      item_description:
        'Revisar el daño de los neumáticos, la presión de inflado, los pernos y las tuercas de las ruedas',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Panel monitor',
      item_description: 'Revisar el panel monitor',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Nivel de aceite en la tren de potencia',
      item_description:
        'Revisar el nivel de aceite en el cárter de la tren de potencia, agregar aceite',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Alarma marcha atrás',
      item_description: 'Verifique que la alarma marcha atrás funcione',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Volante',
      item_description: 'Revisar y ajustar el volante',
    },
    {
      inspection_item_id: '01HK4SS2SR18C29ZQEBDZBSWRK',
      iso_locale_code: 'es',
      item_name: 'Pasador de bloqueo articulado',
      item_description: 'Revisar el pasador de bloqueo articulado',
    },
    {
      inspection_item_id: '01HK4SS2SR913KTB7CFT40BQEH',
      iso_locale_code: 'es',
      item_name: 'Tope de inclinación',
      item_description: 'Comprobación del tope de inclinación',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Nivel de aceite de transmisión',
      item_description:
        'Verificar el nivel de aceite en el cárter de la transmisión',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Dirección secundaria',
      item_description: 'Comprobar la dirección secundaria',
    },
    {
      inspection_item_id: '01HK4T101RKDPTGJ352NN16YPM',
      iso_locale_code: 'es',
      item_name: 'Funcionamiento de los frenos',
      item_description: 'Revisión del funcionamiento de los frenos',
    },
    {
    ...
    //9
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Revisión visual alrededor de la máquina',
      item_description: 'Verificar grietas, daños y el estado del montaje',
    },
    {
      ...
      item_name: 'Revisión visual alrededor del equipo de trabajo',
      item_description:
        'Verificar las tuercas de bloqueo sueltas del cilindro de inclinación',
    },
    {
      inspection_item_id: '01HK4TQMTYCSH5PVKRMMYBAKQD',
      iso_locale_code: 'es',
      item_name: 'Aceite y electrolito de batería',
      item_description:
        'Verificar la fuga de aceite y electrolito de la batería',
    },
    {
      inspection_item_id: '01HK4TQMTYRJACJJ25BS70BBPN',
      iso_locale_code: 'es',
      item_name: 'Nivel de electrolito de la batería',
      item_description: 'Revisar el nivel de electrolito de la batería',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Nivel de aceite freno',
      item_description: 'Revisar nivel de aceite freno',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Freno de estacionamiento',
      item_description: 'Revisar el freno de estacionamiento',
    },
    {
      inspection_item_id: '01HK4TQMTZCKHHTG2Y490D1KG1',
      iso_locale_code: 'es',
      item_name: 'Pedal de freno',
      item_description: 'Revisar el pedal de freno',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Daño en la lámpara y en la lente',
      item_description:
        'Verificar la contaminación y/o daños en la lámpara, lente, etc',
    },
    {
    ...
    },
    {
      ...
      item_name: 'Espejos',
      item_description:
        'Revisar los espejos retrovisores laterales y los espejos retrovisores inferiores',
    },
    {
      inspection_item_id: '01HK4TQMV0BZ3JCMWNRNRRX1N5',
      iso_locale_code: 'es',
      item_name: 'Cinturón de seguridad',
      item_description:
        'Verificar los daños y el funcionamiento del cinturón de seguridad',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'es',
      item_name: 'Sistema de enfriamiento',
      item_description:
        'Verificar y limpiar el radiador/el enfriador de aceite y el enfriador de combustible',
    },
    {
      inspection_item_id: '01HK4WACP1CDWH6K22EAD0PNBS',
      iso_locale_code: 'es',
      item_name: 'Trituradora de mandíbulas',
      item_description: 'Revisar la trituradora de mandíbulas',
    },
    {
      inspection_item_id: '01HK4WACP3BEK5EQCVXYZED95Q',
      iso_locale_code: 'es',
      item_name: 'Cinta transportadora principal',
      item_description: 'Revisar y limpiar la cinta transportadora principal',
    },
    {
      inspection_item_id: '01HK4WACP4TSFPJZJA2C6NH64Y',
      iso_locale_code: 'es',
      item_name: 'Alimentador de la criba',
      item_description: 'Revisar la alimentador de la criba',
    },
    {
      inspection_item_id: '01HK4WACP4JTFZHAD5E59N1TPQ',
      iso_locale_code: 'es',
      item_name: 'Separador magnético',
      item_description: 'Revisar el separador magnético',
    },
    {
