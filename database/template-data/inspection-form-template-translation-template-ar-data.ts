...
export const inspectionFormTemplateTranslationTemplateARData = async (
  ...
  const data: {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      inspection_form_template_name: 'حفارة هيدروليكية ذات الإطارات',
    },
    {
      inspection_form_template_id: '01HK75KH58B8GM11NT1EBJFWPT',
      iso_locale_code: 'ar',
      inspection_form_template_name: 'لودر انزلاقي التوجيه',
    },
    {
      inspection_form_template_id: '01HK75KTXQ83MWNP8TA8YNZGXA',
      iso_locale_code: 'ar',
      inspection_form_template_name: 'كسارة متنقلة',
    },
  ];
