...
export const inspectionItemTemplateTranslationTemplateARData = async (
  ...
  const data: {
    ...
    //1
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'فحص البصري حول معدات العمل',
      item_description:
        'افحص معدات العمل، والأسطوانات، والوصلات، والخراطيم بحثًا عن التلف، والتآكل، والخلوص',
    },
    {
      inspection_item_id: '01HK4QBQJD17KT5ZEYA0N3HVYS',
      iso_locale_code: 'ar',
      item_name: 'فحص بصري حول المعدة',
      item_description:
        'افحص الاجزاء بحثا عن التلف ، والتشوه، والشقوق، والتفكك، والفقد (الضياع)',
    },
    {
      inspection_item_id: '01HK4QBQJD0406HG49VHQ8NFKV',
      iso_locale_code: 'ar',
      item_name: 'التسرب من المحرك/النظام الهيدروليكي',
      item_description:
        'افحص اذا كان هناك تسريب حول المحرك، والمكونات الهيدروليكية، واذا كان هناك تسريب في نظام التبريد في سائل التبريد والزيت',
    },
    {
      inspection_item_id: '01HK4QBQJDNNTZWJ0XB2542Y36',
      iso_locale_code: 'ar',
      item_name: 'مستوى الزيت وسائل التبريد في المحرك/النظام الهيدروليكي',
      item_description:
        'افحص مستوى الزيت في المحرك، والمكونات الهيدروليكية، ونظام التبريد',
    },
    {
      ...
      item_name: 'البطارية',
      item_description:
        'افحص مستوى سائل البطارية، والتشوه، والأوساخ، والانسداد، وارتخاء الأسلاك الكهربائية',
    },
    {
      inspection_item_id: '01HK4QBQJEQV14AKHR3K9VPQKP',
      iso_locale_code: 'ar',
      item_name: 'العمل لمعدات السلامة',
      item_description:
        'تأكد من أن المصابيح الأمامية وإشارات الانعطاف وأجهزة الإنذار المرئية والمسموعة الأخرى تعمل بشكل صحيح ',
    },
    {
      inspection_item_id: '01HK4QBQJEAAV2Y3FZCK2MXDBX',
      iso_locale_code: 'ar',
      item_name: 'تلف معدات السلامة',
      item_description:
        'ابحث عن الشروخ ,الكسور , الفقد في الزجاج  والمرايا والسلالم والدرابزين  (حيثما ينطبق ذلك)',
    },
    {
      inspection_item_id: '01HK4QBQJEHJA5D4NM03SRWR0B',
      iso_locale_code: 'ar',
      item_name: 'الهيكل السفلي، الفرامل، الإطارات',
      item_description:
        'تاكد من حالة الاطارات اذا كانت مثقوبة أو تالفة وافحص أداء المكابح',
    },
    {
      inspection_item_id: '01HK4QBQJEHAGVSPE9M8MV887J',
      iso_locale_code: 'ar',
      item_name: 'المكونات الكهربائية',
      item_description:
        'ابحث عن وجود إنذارات نشطة أو إشعارات مصابيح التحذير في الكابينة وعلى شاشة الإلكترونيات',
    },
    {
      inspection_item_id: '01HK4QFQ1AEVDQYFPYE8HDTX40',
      iso_locale_code: 'ar',
      item_name: 'عداد الخدمة (ساعة)',
      item_description: '',
    },
    {
      inspection_item_id: '01HK4R8HHE4E5R0SKKTJ03RGPR',
      iso_locale_code: 'ar',
      item_name: 'عداد المسافات (كم)',
      item_description: '',
    },
    //2
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'فحص بصري حول معدات العمل',
      item_description:
        'افحص معدات العمل، والأسطوانات، والوصلات، والخراطيم بحثًا عن وجود تلف، أو تآكل، أو خلوص',
    },
    {
      inspection_item_id: '01HK4R9TN723N5286RHTR1GZ74',
      iso_locale_code: 'ar',
      item_name: 'فحص بصري حول الماكينة',
      item_description:
        'افحص الاجزاء بحثا عن التلف ، والتشوه، والشقوق، والتفكك، والفقد (الضياع)',
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'خزان الوقود، فاصل المياه',
      item_description:
        'افحص خزان الوقود، وفاصل المياه وقم بتصريف المياه والرواسب',
    },
    {
      inspection_item_id: '01HK4R9TN78PB15KYDM3ADKRBD',
      iso_locale_code: 'ar',
      item_name: 'مستوى سائل التبريد',
      item_description: 'افحص مستوى سائل التبريد، وأضف سائل التبريد',
    },
    {
      inspection_item_id: '01HK4R9TN7FXK32NVYVQ3MPY90',
      iso_locale_code: 'ar',
      item_name: 'مستوى زيت المحرك',
      item_description: 'افحص مستوى الزيت في وعاء زيت المحرك، أضف الزيت',
    },
    {
      inspection_item_id: '01HK4R9TN7EKDQ76Q4XYN87EWH',
      iso_locale_code: 'ar',
      item_name: 'مستوى الوقود',
      item_description: 'افحص مستوى الوقود، أضف الوقود',
    },
    {
      inspection_item_id: '01HK4R9TN7VSK08626X3ERGZAG',
      iso_locale_code: 'ar',
      item_name: 'مستوى الزيت الهيدروليكي',
      item_description: 'افحص مستوى الزيت في الخزان الهيدروليكي، أضف الزيت',
    },
    {
      inspection_item_id: '01HK4R9TN7RRXCFXHF0YPAMXD1',
      iso_locale_code: 'ar',
      item_name: 'مؤشر الغبار',
      item_description: 'افحص مؤشر الغبار',
    },
    {
      inspection_item_id: '01HK4R9TN8CB8BP9A3K8A3B82Y',
      iso_locale_code: 'ar',
      item_name: 'الأسلاك الكهربائية',
      item_description: 'افحص الأسلاك الكهربائية',
    },
    {
      inspection_item_id: '01HK4R9TN8G1NSF03X4VG3ETMP',
      iso_locale_code: 'ar',
      item_name: 'إضاءة المصابيح',
      item_description: 'تحقق من إضاءة المصابيح',
    },
    {
      inspection_item_id: '01HK4R9TN8BCJYTWZ03ZG9C2WN',
      iso_locale_code: 'ar',
      item_name: 'البوق',
      item_description: 'افحص البوق',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'مستوى زيت ناقل الحركة/مجموعة نقل الحركة',
      item_description:
        'افحص مستوى الزيت في ناقل الحركة/علبة مجموعة نقل الحركة، أضف الزيت',
    },
    {
      ...
      item_name: 'الإطارات',
      item_description:
        'افحص تلف الإطارات، وضغط هواء العجلات، ومسامير العجلات، والصواميل ',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'شاشة المعدة',
      item_description: 'افحص شاشة المعدة',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'مستوى زيت المحرك',
      item_description: 'افحص مستوى الزيت في وعاء زيت المحرك، وأضف الزيت',
    },
    {
      inspection_item_id: '01HK4SF4DAFTC3DDGASF60QZ4B',
      iso_locale_code: 'ar',
      item_name: 'مستوى سائل التبريد',
      item_description: 'افحص مستوى سائل التبريد، أضف سائل التبريد',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'مستوى زيت مجموعة نقل الحركة',
      item_description: 'افحص مستوى الزيت في علبة مجموعة نقل الحركة، أضف الزيت',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: ' انذار الرجوع للخلف',
      item_description: 'افحص تشغيل انذار الرجوع للخلف',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'عجلة القيادة',
      item_description: 'افحص عجلة القيادة واضبطها',
    },
    {
      inspection_item_id: '01HK4SS2SR18C29ZQEBDZBSWRK',
      iso_locale_code: 'ar',
      item_name: 'بنز القفل المفصلي',
      item_description: 'افحص بنز القفل المفصلي',
    },
    {
      inspection_item_id: '01HK4SS2SR913KTB7CFT40BQEH',
      iso_locale_code: 'ar',
      item_name: 'سدادة مائلة',
      item_description: 'افحص السدادة المائلة',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'مستوى زيت ناقل الحركة',
      item_description: 'افحص مستوى الزيت في علبة ناقل الحركة',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'إنذار الرجوع للخلف',
      item_description: 'افحص تشغيل انذار الرجوع للخلف',
    },
    {
      inspection_item_id: '01HK4T101RTWD5T2PB7CX2D320',
      iso_locale_code: 'ar',
      item_name: 'التوجيه الثانوي',
      item_description: 'افحص التوجيه الثانوي',
    },
    {
      inspection_item_id: '01HK4T101RKDPTGJ352NN16YPM',
      iso_locale_code: 'ar',
      item_name: 'عمل المكابح',
      item_description: 'تأكد من عمل المكابح',
    },
    {
    ...
    //9
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'الفحص البصري حول الماكينة',
      item_description: 'افحص الشقوق والتلف وحالة التركيب',
    },
    {
      inspection_item_id: '01HK4TQMTYCSM84FJ5D489BV0T',
      iso_locale_code: 'ar',
      item_name: 'الفحص البصري حول معدات العمل',
      item_description: 'تاكد من ان صواميل قفل أسطوانة الميل ليست مفكوكة',
    },
    {
      inspection_item_id: '01HK4TQMTYCSH5PVKRMMYBAKQD',
      iso_locale_code: 'ar',
      item_name: 'الزيت والكتروليت البطارية',
      item_description: 'افحص تسرب الزيت وإلكتروليت البطارية',
    },
    {
      inspection_item_id: '01HK4TQMTYRJACJJ25BS70BBPN',
      iso_locale_code: 'ar',
      item_name: 'مستوى إلكتروليت البطارية',
      item_description: 'افحص مستوى إلكتروليت البطارية',
    },
    {
      inspection_item_id: '01HK4TQMTYY6CF3FD2GQCG6PND',
      iso_locale_code: 'ar',
      item_name: 'مستوى الزيت الهيدروليكي',
      item_description: 'افحص مستوى الزيت في الخزان الهيدروليكي، وأضف الزيت',
    },
    {
      inspection_item_id: '01HK4TQMTY0TVVGRKN61EM0ANM',
      iso_locale_code: 'ar',
      item_name: 'مستوى زيت المكابح',
      item_description: 'افحص مستوى زيت المكابح',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'فرامل الانتظار',
      item_description: 'افحص فرامل الانتظار',
    },
    {
      inspection_item_id: '01HK4TQMTZCKHHTG2Y490D1KG1',
      iso_locale_code: 'ar',
      item_name: 'دواسة المكابح',
      item_description: 'افحص دواسة المكابح',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'إضاءة المصابيح',
      item_description: 'افحص إضاءة المصابيح',
    },
    {
      inspection_item_id: '01HK4TQMTZNDZGFTSP1ADFEB1M',
      iso_locale_code: 'ar',
      item_name: 'المصباح، تلف العدسة',
      item_description: 'افحص تلوث و/أو تلف المصباح و/أو العدسة وما إلى ذلك',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'المرايا',
      item_description: 'افحص مرايا الرؤية الجانبية ومرايا الرؤية السفلية',
    },
    {
      inspection_item_id: '01HK4TQMV0BZ3JCMWNRNRRX1N5',
      iso_locale_code: 'ar',
      item_name: 'حزام الأمان',
      item_description: 'تأكد من سلامة وأداء حزام الأمان',
    },
    {
    ...
    //10
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'فحص بصري حول الماكينة',
      item_description: 'افحص الشقوق والأضرار وحالة التركيب',
    },
    {
    ...
    },
    {
      ...
      iso_locale_code: 'ar',
      item_name: 'نظام التبريد',
      item_description:
        'افحص وقم بتنظيف المبرد (الريداتير) ومبرد الزيت ومبرد الوقود',
    },
    {
      inspection_item_id: '01HK4WACP1CDWH6K22EAD0PNBS',
      iso_locale_code: 'ar',
      item_name: 'الكسارة الفكية',
      item_description: 'افحص الكسارة الفكية',
    },
    {
      inspection_item_id: '01HK4WACP3BEK5EQCVXYZED95Q',
      iso_locale_code: 'ar',
      item_name: 'الحزام الناقل الرئيسي',
      item_description: 'افحص السير الناقل الرئيسي ونظّفه',
    },
    {
      inspection_item_id: '01HK4WACP4TSFPJZJA2C6NH64Y',
      iso_locale_code: 'ar',
      item_name: 'المغذي القابض',
      item_description: 'افحص المغذي القابض',
    },
    {
      inspection_item_id: '01HK4WACP4JTFZHAD5E59N1TPQ',
      iso_locale_code: 'ar',
      item_name: 'فاصل مغناطيسي',
      item_description: 'افحص الفاصل المغناطيسي',
    },
    {
