...
describe('MachineManufacturerController (e2e): Unauthorized', () => {
...
describe('MachineManufacturerController (e2e)', () => {
  let app: INestApplication;
  ...
  describe('(GET) /machine-manufacturers', () => {
    ...
    it('Should return get list machine manufacture success', async () => {
